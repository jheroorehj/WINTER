...
데스크톱(1920×1080) 단일 화면 EMR 입니다. 번호는 `UI_컴포넌트.jpeg` 의 와이어프레임과 대응합니다.

```
┌──────────────────────────────────────────────┬──────────────┐
│ 1  환자 정보 · 참고 수치 · 데모 케이스 전환    │              │
├───────────────────────┬──────────────────────┤  2           │
│ 3  좌안 (OS)          │ 4  우안 (OD)         │  임상 판단   │
│    AI 추정 오버레이   │    AI 추정 오버레이  │  보조 요약   │
│    클릭 → 확대 뷰어   │    클릭 → 확대 뷰어  │              │
├───────┬───────┬───────┼───────┬───────┬──────┤              │
│ 5     │ 6     │ 7     │ 8     │ 9     │ 10   │              │
│ 좌안 유사 사례 TOP 3  │ 우안 유사 사례 TOP 3 │              │
└───────┴───────┴───────┴───────┴───────┴──────┴──────────────┘
```
